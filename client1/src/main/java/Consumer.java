...
class Consumer implements Runnable {
  ...
  Consumer(BlockingQueue q, TextbodyApi api, CyclicBarrier barrier, Client counter,
           AtomicInteger successfulRequests, AtomicInteger unsuccessfulRequests, Logger logger) {
    queue = q;
    this.api = api;
